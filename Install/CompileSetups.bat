...
rem "C:\Program Files (x86)\NSIS\makensis.exe" M314PMSSetup.nsi
...
"C:\Program Files (x86)\NSIS\makensis.exe" M314PVSTestSetup.nsi
"C:\Program Files (x86)\NSIS\makensis.exe" M314AdminTestSetup.nsi
rem "C:\Program Files (x86)\NSIS\makensis.exe" M314PMSTestSetup.nsi
